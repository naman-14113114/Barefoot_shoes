...
export const metadata: Metadata = {
  ...
  description: "Terms and conditions governing footwear purchases and services on JUUJO. US.",
  alternates: {
...
export default function TermsOfServicePage() {
  return (
    <PolicyView
      ...
      subtitle="Operating terms and purchase agreements for JUUJO. barefoot footwear."
