            ...
            <div className="flex items-center justify-between text-[11px] text-[#000000]">
              <span>
                {totals.isFreeShipping ? (
                  <span className="font-medium text-[#0e855b]">✓ Free Tracked US Delivery Unlocked</span>
                ) : (
                  <>Add ${totals.freeShippingRemaining} more for Free US Delivery</>
                )}
              </span>
                  ...
                  <div className="flex flex-1 flex-col justify-between">
                    <div>
                      ...
                      <p className="text-[12px] text-[#767676]">
                        EU {item.sizeEu} / US {item.sizeUs} / UK {item.sizeUk}
                      </p>
                    </div>
