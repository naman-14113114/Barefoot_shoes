        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div className="space-y-2">
            ...
            <p className="text-[13px] text-[#767676] leading-relaxed">
              All US orders can easily be returned or exchanged free of charge for a different size, color, or model within 14 days via our returns portal.
            </p>
          </div>
          <div className="space-y-2">
            <h4 className="text-[13px] font-medium text-[#000000]">Free & fast US delivery</h4>
            <p className="text-[13px] text-[#767676] leading-relaxed">
              Orders placed before 23:30 EST are dispatched the same day via USPS Priority / FedEx. Enjoy free delivery on all orders above $180.
            </p>
          </div>
        </div>
      </div>
