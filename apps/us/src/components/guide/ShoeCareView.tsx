        ...
        <div className="space-y-10">
          ...
          <div className="border border-[#eaeaea] p-8 space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2 text-[14px] text-[#555555] leading-relaxed">
              ...
              <li><strong>Gentle Cleaning:</strong> Use a slightly damp cloth with mild glycerin-based leather cleanser for surface stains.</li>
              <li><strong>Conditioning:</strong> Apply a neutral beeswax leather cream once every 2 to 3 months to maintain elasticity.</li>
            </ul>
          </div>
          ...
          <div className="border border-[#eaeaea] p-8 space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2 text-[14px] text-[#555555] leading-relaxed">
              <li><strong>Crepe Brushing:</strong> Use a soft crepe suede brush in light strokes to lift the nap and dislodge dust.</li>
              <li><strong>Spot Erasing:</strong> Use a suede eraser for localized marks or water spots.</li>
              <li><strong>Weather Protection:</strong> Spray with a fluorocarbon-free water-repellent spray prior to wet weather wear.</li>
            </ul>
          </div>
          ...
          <div className="border border-[#eaeaea] p-8 space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2 text-[14px] text-[#555555] leading-relaxed">
              <li><strong>Air Drying:</strong> Remove insoles periodically to allow natural moisture evaporation in a shaded, ventilated room.</li>
              <li><strong>Rubber Sole Maintenance:</strong> Clean the zero-drop sole edges using warm water and a soft brush.</li>
            </ul>
          </div>
        </div>
      </div>
