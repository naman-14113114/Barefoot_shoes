      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-b border-[#eaeaea] pb-8 mb-10">
          ...
          <p className="text-[15px] text-[#767676] leading-relaxed max-w-2xl">
            BUUDY. shoes feature a generous anatomical toe box and true European/US sizing. Use the conversion table and measurement steps below to identify your optimal fit.
          </p>
            ...
            <tbody className="divide-y divide-[#eaeaea] text-[#555555]">
              {BAREFOOT_SIZE_MATRIX.map((row) => (
                <tr key={row.eu} className="hover:bg-[#fafafa]">
                  <td className="p-3.5 border border-[#eaeaea] font-medium text-black">{row.usMen}</td>
                  <td className="p-3.5 border border-[#eaeaea]">{row.eu}</td>
        ...
        <div className="border border-[#eaeaea] bg-[#fafafa] p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-[13px] text-[#767676]">
            ...
            <div className="space-y-2">
              ...
              <p>Measure the distance in inches/cm from the wall edge to your mark. Match with our chart above for your perfect size.</p>
            </div>
          </div>
        </div>
      </div>
