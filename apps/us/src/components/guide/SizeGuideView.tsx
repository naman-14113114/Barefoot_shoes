      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-b border-[#eaeaea] pb-8 mb-10">
          ...
          <p className="text-[15px] text-[#767676] leading-relaxed max-w-2xl">
            JUUJO. shoes feature a generous anatomical toe box and true European/US sizing. Use the conversion table and measurement steps below to identify your optimal fit.
          </p>
