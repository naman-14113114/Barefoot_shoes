    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `BUUDY US Support Request: ${formData.subject} - Order: ${formData.orderNumber || "N/A"}`,
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-[#fafafa] border border-[#eaeaea] p-6 md:p-8">
              ...
              <p className="text-[13px] text-[#767676] mb-6">
                Fill in the details below and our US support team will respond within 12–24 hours.
              </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-[13px]">
                  ...
                  {status === "error" && (
                    <div className="p-3 bg-red-50 border border-red-200 text-red-700 text-[12px]">
                      Unable to send form directly. You can email us at{" "}
