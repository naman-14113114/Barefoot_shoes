  ...
  helpCards: [
    {
      ...
      description: "Need help selecting your exact barefoot size or converting from US/EU sizes?",
      href: "/size-guide",
      actionLabel: "View Sizing Guide"
    },
    {
      title: "14-Day Returns & Exchanges",
      description: "Fast, stress-free size swaps with prepaid return labels.",
      href: "/policies/return-policy",
      actionLabel: "Read Return Policy"
    },
    {
      title: "Track Your Order",
      description: "Get real-time USPS / FedEx transit milestones for dispatched packages.",
      href: "/order-tracking",
