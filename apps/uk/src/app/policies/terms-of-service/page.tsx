...
export const metadata: Metadata = {
  ...
  description: "Terms and conditions governing footwear purchases, billing, and services on BUUDY. UK.",
  alternates: {
...
export default function TermsOfServicePage() {
  return (
    <PolicyView
      ...
      subtitle="Operating terms and legal purchase agreements for BUUDY. barefoot footwear."
