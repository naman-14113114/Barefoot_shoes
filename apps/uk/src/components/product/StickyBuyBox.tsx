...
export function StickyBuyBox({ product }: StickyBuyBoxProps) {
  ...
  const lt03Colorways = [
    ...
    },
    {
      ...
      img: "/media/products/lt-03-premium-nappa-light-blue/buudy-barefoot-shoes-lt-03-premium-nappa-light-blue-wide-toe-box-hero.jpg",
    },
    {
      name: "Pink",
      handle: "lt-03-premium-nappa-pink",
      img: "/media/products/lt-03-premium-nappa-pink/buudy-barefoot-shoes-lt-03-premium-nappa-pink-wide-toe-box-hero.jpg",
    },
    {
      name: "Sand",
  ...
  const colorways = product.handle.startsWith("drifters")
    ...
    : product.handle.startsWith("clouders")
      ...
      : product.handle.startsWith("roamers")
        ? roamersColorways
        : product.handle.startsWith("lt-03")
          ? lt03Colorways
  ...
  return (
    <div id="product-details" className="w-full lg:sticky lg:top-[96px] lg:self-start">
      <div>
      ...
      <div className="mt-7 lg:mt-[clamp(18px,3.12vh,28px)]">
        ...
        >
          <span>
            {selectedSizeEu
              ? `EU ${selectedSizeEu} | UK ${selectedVariant.sizeUk} | US ${selectedVariant.sizeUs}`
              : "Select size"}
          </span>
      ...
      <div className="mt-6 border-t border-[#eaeaea] pt-2 space-y-0.5">
          ...
          <AccordionItem id="delivery-info" title="DELIVERY INFO">
            <div className="pt-2 pb-4 space-y-2 text-[13px] text-[#333333]">
              <p className="leading-relaxed font-medium">
                • Standard Delivery (£5, Free on orders over £80) — 2-4 business days via Royal Mail 48 Tracked.
              </p>
              <p className="leading-relaxed">
                • Express Delivery (£10) — 1-2 business days via Royal Mail 24 Tracked / DPD.
              </p>
              <p className="leading-relaxed text-[#555555]">
                • Full end-to-end tracking provided via SMS and email.
              </p>
              <p className="leading-relaxed text-[#555555]">
                • Prepaid Royal Mail return labels included for straightforward exchanges.
              </p>
            </div>
          </AccordionItem>
