...
export function StickyBuyBox({ product }: StickyBuyBoxProps) {
  ...
  return (
    <div className="w-full lg:sticky lg:top-[96px] lg:self-start space-y-5">
      ...
      {/* 3. Pricing Strip (Strict Integer £49 / £99) */}
      ...
      <div className="space-y-2 pt-1">
        ...
        >
          <span>
            {selectedSizeEu
              ? `Size: EU ${selectedSizeEu} | UK ${selectedVariant.sizeUk} | US ${selectedVariant.sizeUs}`
              : "Select size"}
          </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pt-1 text-[12px] text-[#767676]">
        <div className="border border-[#eaeaea] p-3 bg-[#fafafa]">
          <p className="font-medium text-[#000000]">Free & fast UK delivery</p>
          <p className="mt-0.5 text-[11px]">Orders before 23:30 shipped same day. Free over £150.</p>
        </div>
        <div className="border border-[#eaeaea] p-3 bg-[#fafafa]">
