...
export function ProductCard({ product, isPriority = false }: ProductCardProps) {
  ...
  return (
    ...
    >
      {/* 1. Media Aspect Container (4:5 / 115% padding) */}
      ...
      <div className="mt-3 space-y-1">
        ...
        {/* Price Strip (Strict Integer £49 / £99) */}
        <div className="flex items-baseline gap-2 pt-0.5 text-[12px]">
          ...
          <span className="font-medium text-[#000000]">£{product.price}</span>
        </div>
