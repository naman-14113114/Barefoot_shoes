      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-b border-[#eaeaea] pb-8 mb-10">
          ...
          <p className="text-[15px] text-[#767676] leading-relaxed max-w-2xl">
            Enter your order number and email address below to view the latest live Royal Mail status and dispatch milestones.
          </p>
        </div>
            ...
            <div className="mt-8 pt-8 border-t border-[#eaeaea] space-y-4 animate-fadeIn">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-medium text-black">Royal Mail Tracked 24</p>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2">
                <div className="flex gap-3 text-[13px]">
                  ...
                  <div>
                    <p className="font-medium text-black">Sorted at National Distribution Centre</p>
                    <p className="text-[#767676] text-xs">Package in transit to delivery depot</p>
                  </div>
                </div>
                <div className="flex gap-3 text-[13px]">
        ...
        <div className="space-y-4">
          ...
          <div className="p-5 border border-[#eaeaea] bg-white space-y-2">
            ...
            <p className="text-[13px] text-[#767676] leading-relaxed">
              Tracking numbers are generated immediately upon dispatch. Please allow 1 to 2 business days for Royal Mail sorting hubs to register initial scans.
            </p>
          </div>
          <div className="p-5 border border-[#eaeaea] bg-white space-y-2">
