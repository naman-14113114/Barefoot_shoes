        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[13px] text-[#767676] leading-relaxed">
              All UK orders can easily be returned or exchanged free of charge for a different size, color, or model within 14 days via our returns portal.
            </p>
          </div>
          {/* Pillar 2 */}
          <div className="space-y-2">
            <h4 className="text-[13px] font-medium text-[#000000]">Free & fast UK delivery</h4>
            <p className="text-[13px] text-[#767676] leading-relaxed">
              Orders placed before 23:30 are dispatched the same day via Royal Mail Tracked 24/48. Enjoy free delivery on all orders above £150.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-[#eaeaea] py-8 px-6 md:px-12 text-[12px] text-[#767676]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 text-[#313131]">
            ...
            <span className="px-2 py-1 border border-[#eaeaea] bg-white text-[10px] font-medium">KLARNA</span>
