  ...
  helpCards: [
    {
      ...
      description: "Need help selecting your exact barefoot size or converting from UK/US sizes?",
      href: "/size-guide",
    ...
    },
    {
      ...
      description: "Get real-time Royal Mail transit milestones for dispatched packages.",
      href: "/order-tracking",
