...
export const privacyPolicyHtml = `
  ...
  <p class="mb-4">When an order is submitted, we record your name, delivery address, phone number, email address, shoe size, and tokenized payment info.</p>

  <hr class="my-6 border-[#eaeaea]" />
  <h2 class="text-lg font-medium text-black mt-6 mb-3">2. How We Use Information</h2>
  <p class="mb-4">We use your order data to fulfill your barefoot footwear order, process Australia Post delivery, generate tax invoices, provide delivery status alerts, and comply with Australian regulatory requirements.</p>
...
export const termsOfServiceHtml = `
  ...
  <p class="mb-4">Our goods come with guarantees that cannot be excluded under the Australian Consumer Law (ACL). You are entitled to a replacement or refund for a major failure and compensation for any other reasonably foreseeable loss or damage.</p>

  <hr class="my-6 border-[#eaeaea]" />
  <h2 class="text-lg font-medium text-black mt-6 mb-3">Section 2 – Pricing & Currency</h2>
  <p class="mb-4">All prices on the AU storefront are listed in Australian Dollars (A$ AUD). We accept Visa, Mastercard, American Express, Apple Pay, Klarna/Afterpay, and PayPal.</p>
`;
...
export const refundPolicyHtml = `
  ...
  <p class="mb-4">You have <strong>14 calendar days</strong> from the date of Australia Post delivery to request a refund or size exchange.</p>
  ...
  <p class="mb-4">Size exchanges are processed quickly. If your shoes feel too snug or wide, contact us within 14 days and our customer team will arrange an exchange authorization.</p>

  <hr class="my-6 border-[#eaeaea]" />
  <h2 class="text-lg font-medium text-black mt-6 mb-3">3. Refund Settlement</h2>
  <p class="mb-4">Approved refunds are credited back to your original payment method within <strong>3 to 5 business days</strong>.</p>
`;
...
export const returnPolicyHtml = `
  ...
  <ul class="list-disc pl-5 space-y-3 mb-6 text-[#767676]">
    ...
    <li><strong>Shoe Condition:</strong> Please test footwear indoors on clean floors.</li>
  </ul>
`;
...
export const cookiesPolicyHtml = `
  ...
  <ul class="list-disc pl-5 space-y-2 mb-4 text-[#767676]">
    <li><strong>Essential Store Cookies:</strong> Necessary for cart persistence and checkout.</li>
    <li><strong>Performance & Analytics:</strong> Enable anonymous statistical analysis of site speed and performance.</li>
  </ul>
`;
