      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-b border-[#eaeaea] pb-8 mb-10">
          ...
          <p className="text-[15px] text-[#767676] leading-relaxed max-w-2xl">
            BUUDY. shoes feature a generous anatomical toe box and true European/Australian sizing. Use the conversion table and measurement steps below to identify your optimal fit.
          </p>
            ...
            <tbody className="divide-y divide-[#eaeaea] text-[#555555]">
              {BAREFOOT_SIZE_MATRIX.map((row) => (
                <tr key={row.eu} className="hover:bg-[#fafafa]">
                  <td className="p-3.5 border border-[#eaeaea] font-medium text-black">{row.au}</td>
