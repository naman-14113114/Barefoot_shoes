...
export function FrequentlyBoughtTogether() {
  ...
  const relatedItems = [
    ...
    },
    {
      ...
      compareAtPrice: 179,
      badge: "Trending",
      image: "/media/products/lt-03-premium-nappa-dark-blue/buudy-barefoot-shoes-lt-03-premium-nappa-dark-blue-wide-toe-box-hero.jpg",
      variantId: "100099008",
      sizeEu: 42,
    },
    {
    ...
    },
    {
      ...
      title: "LT 02 Rugged White-Black",
    ...
    {
      id: "lt-01-court-lite-nubuck-ash-grey",
      handle: "lt-01-court-lite-nubuck-ash-grey",
      title: "LT 01 Court Lite Nubuck Ash Grey",
      subtitle: "Court Lite Nubuck",
      price: 89,
      compareAtPrice: 179,
      badge: "Trending",
    ...
    {
      id: "lt-01-court-lite-nubuck-essence-white",
      handle: "lt-01-court-lite-nubuck-essence-white",
      title: "LT 01 Court Lite Nubuck Essence White",
      subtitle: "Court Lite Nubuck",
      price: 89,
      compareAtPrice: 179,
      badge: "Trending",
            ...
            <div className="mt-3 space-y-1">
              ...
              <div className="flex items-baseline gap-2 pt-0.5 text-[12px]">
                {item.compareAtPrice > item.price && (
                  <span className="text-[#929292] line-through">A${item.compareAtPrice}</span>
                )}
                <span className="font-medium text-[#000000]">A${item.price}</span>
              </div>
            </div>
